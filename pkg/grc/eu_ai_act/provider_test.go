...
func TestEUAIActControlsLoaded(t *testing.T) {
...
func TestEUAIActFrameworkID(t *testing.T) {
	controls := staticControls()
...
func TestEUAIActNoEmptyTitles(t *testing.T) {
	controls := staticControls()
	for _, ctrl := range controls {
		if ctrl.Title == "" {
...
func TestEUAIActProviderRun(t *testing.T) {
	backend := &mockBackend{}
