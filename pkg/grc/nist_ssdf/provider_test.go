...
func TestNISTSSDFControlsLoaded(t *testing.T) {
...
func TestNISTSSDFFrameworkID(t *testing.T) {
	controls := staticControls()
...
func TestNISTSSDFNoEmptyTitles(t *testing.T) {
	controls := staticControls()
	for _, ctrl := range controls {
		if ctrl.Title == "" {
...
func TestNISTSSDFProviderRun(t *testing.T) {
	backend := &mockBackend{}
