...
func TestNCSCCAFControlsLoaded(t *testing.T) {
...
func TestNCSCCAFFrameworkID(t *testing.T) {
	controls := staticControls()
...
func TestNCSCCAFNoEmptyTitles(t *testing.T) {
	controls := staticControls()
	for _, ctrl := range controls {
		if ctrl.Title == "" {
...
func TestNCSCCAFProviderRun(t *testing.T) {
	backend := &mockBackend{}
