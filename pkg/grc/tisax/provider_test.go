...
func TestTISAXControlsLoaded(t *testing.T) {
...
func TestTISAXFrameworkID(t *testing.T) {
	controls := staticControls()
...
func TestTISAXNoEmptyTitles(t *testing.T) {
	controls := staticControls()
	for _, ctrl := range controls {
		if ctrl.Title == "" {
...
func TestTISAXProviderRun(t *testing.T) {
	backend := &mockBackend{}
